...
Gem::Specification.new do |s|
  ...
  s.date = %q{2011-10-24}
  s.description = %q{Serialize request response}
  s.email = %q{sebastien_luquet@hotmail.com}
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.rdoc"
  ]
  ...
  s.homepage = %q{http://github.com/sebastienluquet/expected_responses}
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.5.2}
  s.summary = %q{Serialize request response}
